...
public class meta6t : MonoBehaviour
{
	...
	private void OnCollisionEnter(Collision col)
	{
		...
		{
			if (manager2.recordnv6 > manager2.contador)
			{
				manager2.recordnv6 = manager2.contador;
				PlayerPrefs.SetFloat("recordnv6", manager2.recordnv6);
			}
