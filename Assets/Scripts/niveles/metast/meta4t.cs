...
public class meta4t : MonoBehaviour
{
	...
	private void OnCollisionEnter(Collision col)
	{
		...
		{
			if (manager2.recordnv4 > manager2.contador)
			{
				manager2.recordnv4 = manager2.contador;
				PlayerPrefs.SetFloat("recordnv4", manager2.recordnv4);
			}
