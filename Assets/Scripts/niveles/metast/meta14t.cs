...
public class meta14t : MonoBehaviour
{
	...
	private void OnCollisionEnter(Collision col)
	{
		...
		{
			if (manager2.recordnv14 > manager2.contador)
			{
				manager2.recordnv14 = manager2.contador;
				PlayerPrefs.SetFloat("recordnv14", manager2.recordnv14);
			}
