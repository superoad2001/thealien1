...
public class meta8t : MonoBehaviour
{
	...
	private void OnCollisionEnter(Collision col)
	{
		...
		{
			if (manager2.recordnv8 > manager2.contador)
			{
				manager2.recordnv8 = manager2.contador;
				PlayerPrefs.SetFloat("recordnv8", manager2.recordnv8);
			}
