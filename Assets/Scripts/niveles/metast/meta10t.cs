...
public class meta10t : MonoBehaviour
{
	...
	private void OnCollisionEnter(Collision col)
	{
		...
		{
			if (manager2.recordnv10 > manager2.contador)
			{
				manager2.recordnv10 = manager2.contador;
				PlayerPrefs.SetFloat("recordnv10", manager2.recordnv10);
			}
