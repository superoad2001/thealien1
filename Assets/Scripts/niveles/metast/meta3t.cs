...
public class meta3t : MonoBehaviour
{
	...
	private void OnCollisionEnter(Collision col)
	{
		...
		{
			if (manager2.recordnv3 > manager2.contador)
			{
				manager2.recordnv3 = manager2.contador;
				PlayerPrefs.SetFloat("recordnv3", manager2.recordnv3);
			}
