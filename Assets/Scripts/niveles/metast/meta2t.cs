...
public class meta2t : MonoBehaviour
{
	...
	private void OnCollisionEnter(Collision col)
	{
		...
		{
			if (manager2.recordnv2 > manager2.contador)
			{
				manager2.recordnv2 = manager2.contador;
				PlayerPrefs.SetFloat("recordnv2", manager2.recordnv2);
			}
