...
public class meta5t : MonoBehaviour
{
	...
	private void OnCollisionEnter(Collision col)
	{
		...
		{
			if (manager2.recordnv5 > manager2.contador)
			{
				manager2.recordnv5 = manager2.contador;
				PlayerPrefs.SetFloat("recordnv5", manager2.recordnv5);
			}
