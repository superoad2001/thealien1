...
public class meta11t : MonoBehaviour
{
	...
	private void OnCollisionEnter(Collision col)
	{
		...
		{
			if (manager2.recordnv11 > manager2.contador)
			{
				manager2.recordnv11 = manager2.contador;
				PlayerPrefs.SetFloat("recordnv11", manager2.recordnv11);
			}
